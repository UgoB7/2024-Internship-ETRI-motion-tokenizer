...
class BVHParser():
    ...
    def _parse_motion(self, bvh, start, stop):
        ...
        # Check that the motion section starts correctly
        if bvh[self.current_token][0] != 'IDENT':
        ...
        # Check that the frames section starts correctly
        ...
        # Check that the frame time section starts correctly
        ...
        # Check that the next token is 'Time'
        ...
        # Initialize frame time and the motions array
        frame_time = 0.0
        ...
        #             print(f"IndexError at token {self.current_token}")
        #             raise e
        #         except ValueError as e:
        #             print(f"ValueError at token {self.current_token}")
        #             raise e
        ...
        #     # print(f"Completed {i} of {stop}")

        # print(f"Successfully parsed motion data from frame {start} to {stop}")